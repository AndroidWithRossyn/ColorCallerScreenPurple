...
import com.amazingtheme.colorcaller.callertheme.OS.adapter.AdapterPer;
...
public class ActivityPerM extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        AdUtils.showNativeAd(ActivityPerM.this, this.adsView0, false);
    ...
    protected void onResume() {
        ...
        AdUtils.loadInitialInterstitialAds(ActivityPerM.this);
        AdUtils.loadAppOpenAds(ActivityPerM.this);
