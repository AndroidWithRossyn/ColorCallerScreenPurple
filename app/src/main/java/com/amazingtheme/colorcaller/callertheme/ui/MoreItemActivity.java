...
public class MoreItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdUtils.showNativeAd(MoreItemActivity.this, adsView0, false);
    ...
    public ArrayList<String> getDownloadsFromSdcard() {
        ...
        File file = new File(android.os.Environment.getExternalStorageDirectory(), "Color Caller Screen One");
