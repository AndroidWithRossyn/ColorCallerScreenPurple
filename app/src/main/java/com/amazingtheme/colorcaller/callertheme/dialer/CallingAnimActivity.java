...
import static com.amazingtheme.colorcaller.callertheme.dialer.RingtoneHelper.setDefaultRingtone;
import static com.amazingtheme.colorcaller.callertheme.dialer.RingtoneHelper.stopRingtone;
...
import com.amazingtheme.colorcaller.callertheme.dialer.helpers.CallListHelper;
import com.amazingtheme.colorcaller.callertheme.dialer.helpers.CallManager;
import com.amazingtheme.colorcaller.callertheme.dialer.helpers.ContactsHelper;
import com.amazingtheme.colorcaller.callertheme.dialer.helpers.NotificationHelper;
...
public class CallingAnimActivity extends AppCompatActivity {
    ...
    FullScreenVideoView gif_default_image_theme;
                ...
                if (action.equals("call_ended")) {
                    ...
                    reply.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            smsIntent.putExtra("sms_body", "Sorry, I can't answer the phone now, I will call you after some time.");
    ...
    private void loadImage() {
        ...
        if (imageUrl != null && gifUrl != null) {
            ...
            if (imageTimestamp > gifTimestamp) {
                ...
                gif_default_image_theme.setVideoURI(videoUri);
                gif_default_image_theme.start();
                gif_default_image_theme.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
                    @Override
                ...
                gif_default_image_theme.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                    @Override
